...
export function TrainingSection() {
  return (
    <section
      ...
      className="mt-2 overflow-hidden text-foreground sm:mt-3"
    >
      <div className="grid items-center gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20 lg:px-12 lg:py-28">
        ...
        <div className="max-w-xl lg:order-1">
          ...
          <p className="mt-7 text-base/7 text-muted-foreground/72 sm:text-lg/8">
            A lot of people can speak. Very few can hold a mic, hold a room, and
            still sound like themselves. Rakesh Jagtiani teaches Hudson Voice
            Technique UK to working professionals, educators, and people who
            want to become voice artists.
          </p>
          <p className="mt-5 text-base/7 text-muted-foreground/72 sm:text-lg/8">
          ...
          <div className="mt-8">
            <Button
              ...
              size="lg"
              className="h-11 rounded-full border border-gray-200 bg-white px-6 text-sm text-[#081d3b] shadow-xl hover:bg-white/90"
            >
