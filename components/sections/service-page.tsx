...
function Headline({
  ...
  return (
    <>
      {before}
      <span className={`${slateChip} inline-block px-2 py-0 whitespace-nowrap`}>
        {accentWord}
      </span>
...
function FactCallout({
  ...
  return (
    <div
      className={
        isTopLeft
          ? "absolute top-0 left-0 z-10 max-w-[min(calc(100%-1rem),17rem)] sm:max-w-xs lg:-top-2 lg:-left-8 xl:-left-12"
          : "absolute right-0 bottom-0 z-10 max-w-[min(calc(100%-1rem),17rem)] sm:max-w-xs lg:-right-6 lg:-bottom-10 xl:-right-10"
      }
    >
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button
                ...
                className={`${slateChip} h-auto px-5 py-2.5 text-sm font-bold transition-[transform,opacity] duration-200 hover:-translate-y-0.5 hover:to-slate-800`}
              >
                Get a quote
              </Button>
              <Button
