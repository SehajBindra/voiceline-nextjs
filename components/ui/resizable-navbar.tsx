  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "dark:bg-background-950/80 bg-background/80 px-4",
        className
      )}
    >
      {children}
...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "text-muted-foreground-600 absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-2",
        className
      )}
    >
      {items.map((item, idx) => (
        <a
          ...
          onClick={onItemClick}
          className="text-foreground-600 relative px-4 py-2 dark:text-neutral-300"
          key={`link-${idx}`}
          href={item.link}
        >
          {hovered === idx && (
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "dark:bg-background-950/80 bg-background/80",
        className
      )}
    >
      {children}
...
export const MobileNavToggle = ({
  ...
  return (
    <button
      ...
      className="flex size-10 items-center justify-center rounded-md text-black dark:text-white"
    >
      <HugeiconsIcon
