...
import { PodcastDuetSvg } from "@/components/hero/podcast-duet-svg"
import { RecordingSessionBwSvg } from "@/components/hero/recording-session-bw-svg"
...
export function SessionDuetMorph({
  className,
  ink = INK,
  holdMs = 5200,
  morphMs = 950,
  ...
  return (
    ...
    >
      <div className="relative aspect-video w-full">
        ...
        >
          <RecordingSessionBwSvg ink={ink} boil={index === 0} />
        </motion.div>
        <motion.div
          aria-hidden={index !== 1}
          className="absolute inset-0"
